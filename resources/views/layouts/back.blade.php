				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{route('home')}}" class="brand-logo">
							<img alt="Logo" src="{{asset('assets/img/logo/sig2.png')}}" style="width:150px;height:150px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('voucher')}}" class="menu-link">
													...
													<span class="menu-text">Diskon/Voucher</span>
												</a>
											</li>
										</ul>
									</div>
								...
								<li class="menu-item" aria-haspopup="true" data-menu-toggle="hover">
									<a href="{{route('order')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
